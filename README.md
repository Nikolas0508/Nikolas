    ...
    class RedacaoBypassEngine {
        ...
        renderConfigPanel() {
            ...
            const fieldBadge = this.state.isTargetTitle ? 
                ...
                `<span class="rb-field-badge rb-badge-body">REDAÇÕES</span>`;

            this.ui.innerHTML = `
                <div class="rb-header">
                    <div style="display:flex; align-items:center; pointer-events:none;">
                        <span class="rb-title">NIKOLAS</span> ${fieldBadge}
                    </div>
                ...
                <div class="rb-footer">feito por <a href="https://www.instagram.com/nikolas_.pereira05/?utm_source=ig_web_button_share_sheet">@Nikolas</a></div>
            `;
